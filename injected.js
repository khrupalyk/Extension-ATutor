function createJsonResponse() {
    ...
    if (testId !== undefined) {
        ...
        try {
            ...
            xmlhttp.open('POST', 'http://94.153.16.146:8080/easytutor/rest/atutor/test/questions', true);
...
if (testForm !== undefined) {
    ...
    $(inp).attr("onclick", "return createJsonResponse();");
    //$(inp).click(function () {
    //        createXmlResponse();
    //    }
    //);
...
function sendResponse(result) {
    ...
    //$.ajax({
    //    url: 'http://94.153.16.146:8080/easytutor/rest/atutor/test/questions',
    //    data: JSON.stringify(""),
